...
backend games-api-1 { .host = "games-api-1"; .port = "9111"; }
backend games-api-2 { .host = "games-api-2"; .port = "9155"; }

sub vcl_init {

    // set up a round-robin director with two backends
    new round_robin_director = directors.round_robin();
    round_robin_director.add_backend(games-api-1);
    round_robin_director.add_backend(games-api-2);
}
